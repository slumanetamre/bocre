...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[40], {
    5040: function(t, e, s) {
        ...
        let l = {
          ...
          , p = "function" == typeof Blob || "undefined" != typeof Blob && "[object BlobConstructor]" === Object.prototype.toString.call(Blob)
          ...
          , f = ({type: t, data: e}, s, i) => p && e instanceof Blob ? s ? i(e) : y(e, i) : u && (e instanceof ArrayBuffer || d(e)) ? s ? i(e) : y(new Blob([e]), i) : i(h[t] + (e || ""))
          , y = (t, e) => {
        ...
        let b = t => {
            ...
            for (i = 0; i < s; i += 4)
                n = _[t.charCodeAt(i)],
                o = _[t.charCodeAt(i + 1)],
                a = _[t.charCodeAt(i + 2)],
                h = _[t.charCodeAt(i + 3)],
                l[r++] = n << 2 | o >> 4,
                l[r++] = (15 & o) << 4 | a >> 2,
                l[r++] = (3 & a) << 6 | 63 & h;
            return c
        ...
        ;
        let B = "function" == typeof Promise && "function" == typeof Promise.resolve ? t => Promise.resolve().then(t) : (t, e) => e(t, 0)
          , x = "undefined" != typeof self ? self : "undefined" != typeof window ? window : Function("return this")();
        function N(t, ...e) {
        ...
        let S = x.setTimeout
          , L = x.clearTimeout;
        function q(t, e) {
            e.useNativeTimers ? (t.setTimeoutFn = S.bind(x),
            t.clearTimeoutFn = L.bind(x)) : (t.setTimeoutFn = x.setTimeout.bind(x),
        ...
        class D extends C {
            ...
            onError(t, e, s) {
                return super.emitReserved("error", new j(t,e,s)),
                this
            }
            open() {
        ...
        class U extends D {
            ...
            onData(t) {
                T(t, this.socket.binaryType).forEach(t => {
            ...
            uri() {
                let t = this.opts.secure ? "https" : "http"
                  , e = this.query || {};
                return !1 !== this.opts.timestampRequests && (e[this.opts.timestampParam] = P()),
        ...
        class H extends C {
            ...
            _create() {
                var t;
                let e = N(this._opts, "agent", "pfx", "key", "passphrase", "cert", "ca", "ciphers", "rejectUnauthorized", "autoUnref");
                ...
                try {
                    ...
                    try {
                        if (this._opts.extraHeaders)
                            ...
                            this._opts.extraHeaders)
                                this._opts.extraHeaders.hasOwnProperty(t) && s.setRequestHeader(t, this._opts.extraHeaders[t])
                    } catch (t) {}
                    ...
                    s.onreadystatechange = () => {
                        var t;
                        3 === s.readyState && (null === (t = this._opts.cookieJar) || void 0 === t || t.parseCookies(s.getResponseHeader("set-cookie"))),
                ...
                "undefined" != typeof document && (this._index = H.requestsCount++,
            ...
            _cleanup(t) {
                if (void 0 !== this._xhr && null !== this._xhr) {
                    if (this._xhr.onreadystatechange = M,
                    t)
                        try {
                            this._xhr.abort()
                        } catch (t) {}
        ...
        H.requestsCount = 0,
        H.requests = {},
        "undefined" != typeof document && ("function" == typeof attachEvent ? attachEvent("onunload", K) : "function" == typeof addEventListener && addEventListener("onpagehide"in x ? "pagehide" : "unload", K, !1));
        let W = function() {
            let t = z({
                xdomain: !1
            });
        ...
        let J = "undefined" != typeof navigator && "string" == typeof navigator.product && "reactnative" === navigator.product.toLowerCase();
        class $ extends D {
            get name() {
                return "websocket"
            }
            doOpen() {
                let t = this.uri()
                  ...
                  , s = J ? {} : N(this.opts, "agent", "perMessageDeflate", "pfx", "key", "passphrase", "cert", "ca", "ciphers", "rejectUnauthorized", "localAddress", "protocolVersion", "origin", "maxPayload", "family", "checkServerIdentity");
            ...
            uri() {
                let t = this.opts.secure ? "wss" : "ws"
                  , e = this.query || {};
                return this.opts.timestampRequests && (e[this.opts.timestampParam] = P()),
                this.supportsBinary || (e.b64 = 1),
                this.createUri(t, e)
            }
        }
        let Q = x.WebSocket || x.MozWebSocket;
        class X extends $ {
            createSocket(t, e, s) {
                return J ? new Q(t,e,s) : e ? new Q(t,e) : new Q(t)
            }
            doWrite(t, e) {
                this.ws.send(e)
            }
                          ...
                          , n = new TransformStream({
                            transform(t, e) {
                                ...
                                s = s => {
                                    ...
                                    let r = s.length;
                                    if (r < 126)
                                        new DataView((i = new Uint8Array(1)).buffer).setUint8(0, r);
                                    else if (r < 65536) {
                                        let t = new DataView((i = new Uint8Array(3)).buffer);
                                        t.setUint8(0, 126),
                                        t.setUint16(1, r)
                                    } else {
                                        let t = new DataView((i = new Uint8Array(9)).buffer);
                                        t.setUint8(0, 127),
                                ...
                                ,
                                p && t.data instanceof Blob ? t.data.arrayBuffer().then(g).then(s) : u && (t.data instanceof ArrayBuffer || d(t.data)) ? s(g(t.data)) : f(t, !1, t => {
                                    i || (i = new TextEncoder),
                                    s(i.encode(t))
                                }
                                )
        ...
        let ti = "function" == typeof addEventListener && "function" == typeof removeEventListener
          , tr = [];
        ti && addEventListener("offline", () => {
            tr.forEach(t => t())
        }
        , !1);
        class tn extends C {
            constructor(t, e) {
                ...
                t) {
                    ...
                    e.host && (e.hostname = ts(e.host).host);
                q(this, e),
                ...
                ti && (this.opts.closeOnBeforeunload && (this._beforeunloadEventListener = () => {
            ...
            _open() {
                ...
                let t = this.opts.rememberUpgrade && tn.priorWebsocketSuccess && -1 !== this.transports.indexOf("websocket") ? "websocket" : this.transports[0];
            ...
            write(t, e, s) {
                return this._sendPacket("message", t, e, s),
                this
            }
            send(t, e, s) {
                return this._sendPacket("message", t, e, s),
            ...
            _onClose(t, e) {
                if ("opening" === this.readyState || "open" === this.readyState || "closing" === this.readyState) {
                    ...
                    ti && (this._beforeunloadEventListener && removeEventListener("beforeunload", this._beforeunloadEventListener, !1),
                    ...
                    e.once("packet", t => {
                        if (!s) {
                            if ("pong" === t.type && "probe" === t.data)
                                ...
                                e && (tn.priorWebsocketSuccess = "websocket" === e.name,
        ...
        class ta extends to {
            constructor(t, e={}) {
                ...
                (!s.transports || s.transports && "string" == typeof s.transports[0]) && (s.transports = (s.transports || ["polling", "websocket", "webtransport"]).map(t => Z[t]).filter(t => !!t)),
                super(t, s)
            }
        }
        ta.protocol;
        let th = "function" == typeof ArrayBuffer
          , tc = t => "function" == typeof ArrayBuffer.isView ? ArrayBuffer.isView(t) : t.buffer instanceof ArrayBuffer
          , tl = Object.prototype.toString
          , tp = "function" == typeof Blob || "undefined" != typeof Blob && "[object BlobConstructor]" === tl.call(Blob)
          , tu = "function" == typeof File || "undefined" != typeof File && "[object FileConstructor]" === tl.call(File);
        function td(t) {
            return th && (t instanceof ArrayBuffer || tc(t)) || tp && t instanceof Blob || tu && t instanceof File
        }
        let tf = ["connect", "connect_error", "disconnect", "disconnecting", "newListener", "removeListener"]
          , ty = 5;
        ...
        class t_ extends C {
            ...
            add(t) {
                ...
                if ("string" == typeof t) {
                    ...
                    let s = (e = this.decodeString(t)).type === o.BINARY_EVENT;
                    s || e.type === o.BINARY_ACK ? (e.type = s ? o.EVENT : o.ACK,
                    this.reconstructor = new tb(e),
            ...
            static isPayloadValid(t, e) {
                ...
                case o.CONNECT_ERROR:
                    return "string" == typeof e || tm(e);
                case o.EVENT:
                case o.BINARY_EVENT:
                    return Array.isArray(e) && ("number" == typeof e[0] || "string" == typeof e[0] && -1 === tf.indexOf(e[0]));
                case o.ACK:
                case o.BINARY_ACK:
                ...
                this.buffers.length === this.reconPack.attachments) {
                    ...
                    e.data = function t(e, s) {
                        ...
                        if (e && !0 === e._placeholder) {
                            if ("number" == typeof e.num && e.num >= 0 && e.num < s.length)
                                return s[e.num];
                            throw Error("illegal attachments")
                        }
                        if (Array.isArray(e))
        ...
        class tw extends C {
            ...
            subEvents() {
                if (this.subs)
                    return;
                let t = this.io;
                this.subs = [tv(t, "open", this.onopen.bind(this)), tv(t, "packet", this.onpacket.bind(this)), tv(t, "error", this.onerror.bind(this)), tv(t, "close", this.onclose.bind(this))]
            }
            get active() {
                return !!this.subs
            }
            ...
            emit(t, ...e) {
                ...
                "function" == typeof e[e.length - 1]) {
                    let t = this.ids++
                      , s = e.pop();
                    this._registerAckCallback(t, s),
                    n.id = t
                }
                let a = null === (i = null === (s = this.io.engine) || void 0 === s ? void 0 : s.transport) || void 0 === i ? void 0 : i.writable
                  , h = this.connected && !(null === (r = this.io.engine) || void 0 === r ? void 0 : r._hasPingExpired());
                return this.flags.volatile && !a || (h ? (this.notifyOutgoingListeners(n),
            ...
            _clearAcks() {
                Object.keys(this.acks).forEach(t => {
                    if (!this.sendBuffer.some(e => String(e.id) === t)) {
                        let e = this.acks[t];
                        delete this.acks[t],
                        e.withError && e.call(this, Error("socket has been disconnected"))
                    }
                }
                )
            }
            ...
            emitEvent(t) {
                if (this._anyListeners && this._anyListeners.length)
                    for (let e of this._anyListeners.slice())
                        e.apply(this, t);
        ...
        class tA extends C {
            ...
            open(t) {
                if (~this._readyState.indexOf("open"))
                    return this;
                this.engine = new ta(this.uri,this.opts);
                let e = this.engine
                  , s = this;
                this._readyState = "opening",
                this.skipReconnect = !1;
                let i = tv(e, "open", function() {
                    s.onopen(),
                    t && t()
                })
                  , r = e => {
            ...
            onopen() {
                ...
                this.emitReserved("open");
                let t = this.engine;
                this.subs.push(tv(t, "ping", this.onping.bind(this)), tv(t, "data", this.ondata.bind(this)), tv(t, "error", this.onerror.bind(this)), tv(t, "close", this.onclose.bind(this)), tv(this.decoder, "decoded", this.ondecoded.bind(this)))
            }
            onping() {
                this.emitReserved("ping")
            }
            ...
            socket(t, e) {
                let s = this.nsps[t];
                return s ? this._autoConnect && !s.active && s.connect() : (s = new tw(this,t,e),
                this.nsps[t] = s),
                s
            }
            _destroy(t) {
        ...
        function tO(t, e) {
            ...
            let i = function(t, e="", s) {
                ...
                i.path = i.path || "/";
                let r = -1 !== i.host.indexOf(":") ? "[" + i.host + "]" : i.host;
                return i.id = i.protocol + "://" + r + ":" + i.port + e,
                i.href = i.protocol + "://" + r + (s && s.port === i.port ? "" : ":" + i.port),
                i
            }(t, (e = e || {}).path || "/socket.io")
              , r = i.source
              , n = i.id
              , o = i.path
              , a = tT[n] && o in tT[n].nsps;
            return e.forceNew || e["force new connection"] || !1 === e.multiplex || a ? s = new tA(r,e) : (tT[n] || (tT[n] = new tA(r,e)),
            s = tT[n]),
